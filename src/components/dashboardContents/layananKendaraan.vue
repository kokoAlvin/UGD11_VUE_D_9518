...
<v-container>
    ...
    <v-card>
        ...
        <v-container>
            ...
            <v-col cols="12">
                <v-text-field label="Biaya*" v-model="form.price" required></v-text-field>
            </v-col>
            <v-col cols="12">
                <v-select v-bind:items="type" v-model="form.type" label="Jenis Layanan" required></v-select>
            </v-col>
            </v-row>
        </v-container>
...
methods: {
    getData() {
    var url = this.$apiUrl + '/layanankendaraan'
    ...
    this.service.append('price', this.form.price);
    this.service.append('type', this.form.type);
    var url = this.$apiUrl + '/layanankendaraan/' + this.updatedId;
    this.load = true
    this.$http
    ...
    deleteData(deleteId) {
    var url = this.$apiUrl + '/layanankendaraan/' + deleteId;
